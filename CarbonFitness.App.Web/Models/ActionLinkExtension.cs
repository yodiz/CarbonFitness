...
namespace CarbonFitness.App.Web.Models {
	...
	//      return String.Format(helper.ActionLink(action, "{0}"), ImageExtensions.Image(helper, imageRelativeUrl, alt));
	//   }
	...
	//      return String.Format(helper.ActionLink(action, "{0}"), ImageExtensions.Image(helper, imageRelativeUrl, alt, htmlAttributes));
	//   }
	//}
}